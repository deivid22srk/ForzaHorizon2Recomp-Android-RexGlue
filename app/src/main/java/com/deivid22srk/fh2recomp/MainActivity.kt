...
import com.deivid22srk.fh2recomp.ui.DataSelectionRoute
import com.deivid22srk.fh2recomp.ui.settings.SettingsRoute
import com.deivid22srk.fh2recomp.ui.theme.PortScreenTheme
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            PortScreenTheme {
                ...
                // e roda o SDL_main do motor nativo (libfh2.so).
                // ==========================================================
                selectionViewModel.onLaunchGame = { _, _ ->
                    startActivity(
                        android.content.Intent(this, com.deivid22srk.fh2recomp.game.GameActivity::class.java)
                    )
                }
