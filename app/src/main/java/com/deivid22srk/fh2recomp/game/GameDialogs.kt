...
/**
 * Diálogos do jogo — design "Horizonte" (a mesma identidade do launcher).
 *
 ...
 */
// Paleta Horizonte (espelha PortBranding sem depender de Compose).
private const val COL_BG = 0xF20B0B10.toInt()        // carvão 95%
private const val COL_ROW = 0x0D14131A                // linhas internas
private const val COL_AMBER = 0xFF3EC6FF.toInt()     // ciano horizonte
private const val COL_AMBER_DIM = 0x663EC6FF.toInt()  // ciano 40%
private const val COL_AMBER_DEEP = 0xFF1B6CA8.toInt()
...
private const val COL_INK = 0xFF06121C.toInt()       // texto sobre ciano
...
class QuickSettingsDialog(
     ...
     * das Configurações, gravada no fechamento → fh2.toml no próximo
     * boot).
     */
