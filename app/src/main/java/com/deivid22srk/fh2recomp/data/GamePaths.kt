package com.deivid22srk.fh2recomp.data

import android.content.Context
import java.io.File

/**
 * Caminhos de dados do port Forza Horizon 2 Recomp.
 *
 ...
 *  - [configFile]  : fh2.toml gerado a partir das Configurações do app.
 */
object GamePaths {
    ...
    /** Mesmo arquivo de prefs usado pelo [com.deivid22srk.fh2recomp.viewmodel.DataSelectionViewModel]. */
    ...
    fun configFile(context: Context): File =
        File(context.filesDir, "fh2.toml")
